...
<head>
    ...
    <title>Dashboard &mdash; SMK Nasional Bandung</title>
    <link rel="shortcut icon" href="{{ asset('assets/img/school.svg') }}" type="image/x-icon">
    <!-- General CSS Files -->
    <link rel="stylesheet" href="{{ asset('assets/modules/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/modules/fontawesome/css/all.min.css') }}">
    <link rel="shortcut icon" href="{{ asset('assets/img/logo-smk.png') }}" type="image/x-icon">
    <!-- CSS Libraries -->
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <center>
                            <img src="{{ asset('assets/img/logo-smk.png') }}" width="100px" alt="">
                        </center>
                        <a href="index.html">SMK Nasional Bandung</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">
                            <center>
                                <img src="{{ asset('assets/img/logo-smk.png') }}" width="30px" alt="">
                            </center>
                        </a>
                    </div>
